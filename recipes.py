...
def slope_complexity():
    ...
    """
    norm_loc = DATA_DIR / f"all_keywords_threshold_{FREQ}_{SCORE}_{HARD}.csv"
...
def plot_slope():
    ...
    plot_slop_complex(se_df, VIZ_DIR, x_measure="mean_change", y_measure='number_cwt_peaks')
...
def docs_to_keywords_df():
    ...
    flatten_to_keywords(df, outfile, MIN_THRESH)
